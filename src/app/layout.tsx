...
export const metadata: Metadata = {
  title: "Козацька Кухня - Традиційні Українські Рецепти",
  description: "Автентичні рецепти української кухні: борщ, сало, вареники. Готуємо з душею!",
  keywords: "українська кухня, борщ, сало, вареники, традиційні рецепти",
  openGraph: {
    title: "Козацька Кухня - Традиційні Українські Рецепти",
    description: "Автентичні рецепти української кухні",
    siteName: "Козацька Кухня",
    images: [{
      url: "https://images.pexels.com/photos/708587/pexels-photo-708587.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Українські страви"
    }]
  }
};
